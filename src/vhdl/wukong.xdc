...
# Switches and LEDs.
################################################################################
set_property -dict {PACKAGE_PIN H7  IOSTANDARD LVCMOS33} [get_ports btnCpuReset];
...
set_property -dict {PACKAGE_PIN L4 IOSTANDARD LVCMOS33} [get_ports sd2Clock];
set_property -dict {PACKAGE_PIN J6 IOSTANDARD LVCMOS33} [get_ports sd2Reset];
set_property -dict {PACKAGE_PIN M5 IOSTANDARD LVCMOS33} [get_ports sd2MISO ];
